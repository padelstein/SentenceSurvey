...
public class SentenceSurvey
{
	...
	public void createSomeHIT(SentenceHIT hit) throws FileNotFoundException
	{
		try 
		{
			...
			(
					...
					"someDescription",
					null,
					HIThtml(inputHIT.originalSentence, inputHIT.sentence1, inputHIT.sentence2, inputHIT.sentence3, inputHIT.sentence4),
					00.05,
					(long)300,
					(long)432000, 
					(long)172800, 
	...
	public static String HIThtml(String originalSentence, String sentence1, String sentence2, String sentence3, String sentence4) {
		String q = "";
