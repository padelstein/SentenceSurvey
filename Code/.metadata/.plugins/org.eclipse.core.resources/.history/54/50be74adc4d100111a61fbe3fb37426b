...
public class SentenceHIT 
{
	...
	public void updateWithAmazon(String HITid)
	{
		...
		if ( dataID.equals(amazonHIT.getRequesterAnnotation()))
		{	calcAnswers();
		} else {
			System.out.println("dataID numbers do not mach");
		}
	}
	...
	public void approveAllAssignments()
	{
		Assignment[] assignments = service.getAllSubmittedAssignmentsForHIT(ID);
	...
	public String toString()
	{
		return "Original : " + originalSentence
				+ "\n" + sentence1 + answers1.toString()
				+ "\n" + sentence2 + answers2.toString()
				+ "\n" + sentence3 + answers3.toString()
				+" \n" + sentence4 + answers4.toString();
	}
}
